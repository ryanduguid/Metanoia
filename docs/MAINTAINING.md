...
- Ryan confirmed on 26 September 2026 that `https://www.linkedin.com/in/ryan-duguid/` is active for professional connections. This supersedes the inactive-profile restriction from [#16](https://github.com/ryanduguid/Metanoia/pull/16). Keep public LinkedIn references consistent with that status and distinguish this Australian profile from the US namesake's unhyphenated URL. Account metadata changes still require explicit user authorisation.
